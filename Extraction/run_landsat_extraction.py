...
if __name__ == "__main__":
    ...
    train_features = extract_with_checkpoints(
        Water_Quality_df, '../Data/landsat_features_training.csv', checkpoint_every=100
    )
    ...
    train_features.to_csv('../Data/landsat_features_training.csv', index=False)
    ...
    val_features = extract_with_checkpoints(
        Validation_df, '../Data/landsat_features_validation.csv', checkpoint_every=50
    )
    ...
    val_features = val_features[['Latitude', 'Longitude', 'Sample Date',
                                  'blue', 'green', 'red', 'nir', 'swir16', 'swir22',
                                  'NDMI', 'MNDWI', 'NDVI', 'NDTI', 'BSI']]
    val_features.to_csv('../Data/landsat_features_validation.csv', index=False)
